...
(function () {
  ...
  angular.module('BlurAdmin.main.dashboard.equity.ticker').config(chartJsConfig)
    .controller('TickerLineChartCtrl', TickerLineChartCtrl);
  ...
  /** @ngInject */
  function TickerLineChartCtrl($scope, DashboardService) {
